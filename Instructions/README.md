...
# Conclusion
If you were able to follow all of the instructions above in the implementation section, you have successfully completed the tutorial. Congratulations. To close your live server, type the following command in your terminal: docker-compose down
